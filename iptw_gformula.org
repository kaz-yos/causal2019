...
\begin{align*}
  ...
  &= E[E[Y^{a_{0}} | A_{0}, L_{0}]]\\
  &~~~\text{By exchangeability, }E[Y^{a_{0}} | A_{0}, L_{0}] = E[Y^{a_{0}} | A_{0} = a_{0}, L_{0}]\\
  &= E \left[ E[Y^{a_{0}} | A_{0} = a_{0}, L_{0}] \right]\\
  &~~~\text{Insert an expression that is 1.}\\
  &= E \left[ \frac{f(A_{0}=a_{0} | L_{0})}{f(A_{0}=a_{0} | L_{0})} E[Y^{a_{0}} | A_{0} = a_{0}, L_{0}] \right]\\
  &~~~\text{By stability, } g(L_{0}) = E[g(L_{0}) | L_{0}].\\
  &= E \left[ \frac{E[f(A_{0}=a_{0} | L_{0}) | L_{0}]}{f(A_{0}=a_{0} | L_{0})} E[Y^{a_{0}} | A_{0} = a_{0}, L_{0}] \right]\\
  &~~~\text{Probability = Expectation of indicator}\\
  &= E \left[ \frac{E[E[I(A_{0}=a_{0}) | L_{0}] | L_{0}]}{f(A_{0}=a_{0} | L_{0})} E[Y^{a_{0}} | A_{0} = a_{0}, L_{0}] \right]\\
  &~~~\text{By tower property}\\
  &= E \left[ \frac{E[I(A_{0}=a_{0}) | L_{0}]}{f(A_{0}=a_{0} | L_{0})} E[Y^{a_{0}} | A_{0} = a_{0}, L_{0}] \right]\\
  ...
  &~~~\text{By consistency, }I(A_{0}=a_{0})Y^{a_{0}} = Y \text{ for } A_{0} = a_{0}\\
  &~~~\text{Also, }I(A_{0}=a_{0})Y^{a_{0}} = I(A_{0}=a_{0})Y = 0 \text{ for } A_{0} \ne a_{0}\\
